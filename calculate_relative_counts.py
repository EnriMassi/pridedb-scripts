...
# In[ ]:
sumcounts = pd.read_csv(f"./{dataset}_{year}{month}{day}/{year}-{month}-{day}_Normalized_Counts.csv.gz")
...
# sumcounts.to_csv(f"./{dataset}_{year}{month}{day}/{year}-{month}-{day}_Relative_Counts_pt1_.csv.gz",
...
# modcounts.to_csv(f"./{dataset}_{year}{month}{day}/{year}-{month}-{day}_Relative_Counts_pt2_.csv.gz",
#                  index=False, compression='gzip')
...
relative_counts.to_csv(f"./{dataset}_{year}{month}{day}/{year}-{month}-{day}_Relative_Counts.csv.gz",
                       index=False, compression='gzip')
