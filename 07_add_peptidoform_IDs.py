...
# In[5]:
peptidoforms = pd.read_csv(parser.parse_args().peptidoforms_file, low_memory=False, usecols=[1,4,5,6,7,8,9,10,11,12])
...
merged_data.to_csv(parser.parse_args().other_file+'.csv.gz', index=False, compression='gzip')
